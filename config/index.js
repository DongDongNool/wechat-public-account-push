export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx87cc8f2f1afa3c03",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3ddd4446d92edb0d6e5561d7fe34c45c",
  ...
  USERS: [
    {
      ...
      id: "o-ysU510tD1OFiY_b7Iq7zl54T6g",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "TRw9Wx8Ittd5TlV2lRVa0XnS1K_DecIRqZfj9clkV2E",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "棟棟", "year": "1999", "date": "12-07"},
